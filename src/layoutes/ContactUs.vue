<template>
  <section class="bg-slate-100 dark:bg-slate-800" id="contact">
    <div class="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
      <div class="mb-4">
        ...
        >
          <p
            class="text-base font-semibold uppercase tracking-wide text-blue-900 dark:text-blue-200"
          >
            {{ $t("Contact.title1") }}
          </p>
          <h2
        ...
        <div class="grid md:grid-cols-2">
          <div class="h-full pr-6">
            <ul class="mb-6 md:mb-0">
              <li class="flex">
                <div
                  class="flex size-10 items-center justify-center rounded bg-blue-900 text-gray-50"
                >
                  <svg
                ...
                <div class="mx-4 mb-4">
                  ...
                  <p
                    class="text-gray-600 capitalize text-sm dark:text-slate-400"
                  >
                    {{ $t("Contact.Address2") }}
                  </p>
                </div>
              ...
              <li class="flex">
                ...
                <div class="mx-4 mb-4">
                  ...
                  <p class="text-gray-600 dark:text-slate-400 ltr">
                    <span>
                      {{ $t("Contact.mobile") }}
                    </span>
                    <span class="ltr inline-block mx-1"> 091-5732894 </span>
                  </p>
                </div>
              </li>
              <li class="flex">
          ...
          <div class="card h-fit max-w-6xl p-5 md:p-12" id="form">
            <h2 class="mb-4 text-2xl capitalize font-bold">
